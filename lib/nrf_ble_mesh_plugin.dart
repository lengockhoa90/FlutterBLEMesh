...
class NrfBleMeshPlugin {
  ...
  Future<bool> sendSaveGatewayMessage({required int address, required String opCodeString, String? param}) async {
    ...
    return await _channel.invokeMethod("sendSaveGatewayMessage", data);
  }
